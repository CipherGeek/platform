...
3.  2. If you want the docs to be imported to a separate new teamspace, use this command:
...
```
rushx run-local import-notion-with-teamspaces /home/Export-fad9ecb4-a1a5-4623-920d-df32dd423743 \
...
```
rushx run-local import-notion-to-teamspace /home/Export-fad9ecb4-a1a5-4623-920d-df32dd423743 \
--user john.doe@gmail.com \
--password qwe1234 \
--workspace ws1 \
--teamspace imported
...
docker run \
  ...
  -- bundle.js import-notion-with-teamspaces ${dir} \
...
docker run \
  ...
  -e FRONT_URL="https://huly.app" \
  hardcoreeng/tool:latest \
  -- bundle.js import-notion-to-teamspace ${dir} \
--user jane.doe@gmail.com
--password 4321qwe
--workspace ws1
--teamspace notion
